...
interface ComponentRowProps {
  component: Component;
  isProcessed: boolean;
  componentStatus?: ComponentStatus | null; // Status passé en prop pour que memo() détecte les changements
...
export const ComponentRow = memo(function ComponentRow({
  component,
  isProcessed,
  componentStatus, // Status passé en prop
  onToggleProcessed,
  onPress,
  onLongPress,
  onHide,
  ...
  // Actions du store (pas besoin de lire l'état, il est passé en prop)

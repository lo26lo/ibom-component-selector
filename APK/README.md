...
### Mode E-ink 📟
- **Bouton 📟** dans la toolbar pour activer/désactiver
- **Haut contraste** : fond blanc, composants noirs/gris
- **Optimisé pour liseuses e-ink** (Onyx Boox, etc.)
- Réduit les niveaux de gris pour un affichage net
